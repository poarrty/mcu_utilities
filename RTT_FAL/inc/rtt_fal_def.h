...
/* debug level log */
#ifdef  fal_flash_log_d
#undef  fal_flash_log_d
#endif
#define fal_flash_log_d(...)                     FAL_PRINTF("[D/FAL] (%s:%d) ", __FUNCTION__, __LINE__);           FAL_PRINTF(__VA_ARGS__);FAL_PRINTF("\r\n")
...
#undef  fal_flash_log_d
#endif
#define fal_flash_log_d(...)
#endif /* FAL_DEBUG */

/* error level log */
#ifdef  fal_flash_log_e
#undef  fal_flash_log_e
#endif
#define fal_flash_log_e(...)                     FAL_PRINTF("\033[31;22m[E/FAL] (%s:%d) ", __FUNCTION__, __LINE__);FAL_PRINTF(__VA_ARGS__);FAL_PRINTF("\033[0m\r\n")

/* info level log */
#ifdef  fal_flash_log_i
#undef  fal_flash_log_i
#endif
#define fal_flash_log_i(...)                     FAL_PRINTF("\033[32;22m[I/FAL] ");                                FAL_PRINTF(__VA_ARGS__);FAL_PRINTF("\033[0m\r\n")
